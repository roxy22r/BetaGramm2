  ...
  <div class="fightersContainer">
    <div class="card" id="fighterOne">
      ...
      <div class="cardInfo">
        ...
        <button type="button" class="btn btn-dark BG_btn" v-on:click="deltePlayer($event, playerOne.id)">Delete</button>
        <button type="button" class="btn btn-dark BG_btn">Edit</button>
        <li><button type="button" class="btn btn-dark BG_btn" v-on:click="onPlay($event, playerOne.id)">Play</button></li>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    fight(event) {
      ...
      if (strikeCount > 2) {
         this.winnerText= this.playerOne.firstname + " " + this.playerOne.lastname + " is the winner ";
        this.playerOne.winnings += 1;
      }
      else {
        this.winnerText = this.playerTwo.firstname + " " + this.playerTwo.lastname + " is the winner ";
    ...
    resetfighter(event) {
      ...
      this.playerOne = emptyPlayer;
      this.playerTwo = emptyPlayer;
